...
/**
 * A LOADER ITT LOG, ES EZ ELSO ALKALOM EBBEN A REPOBAN.
 *
 * Miert EBBEN a modulban: a hat szallitasi-mod azonosito BEALLITAS, es ez a
 * beallitasok modulja. Nincs sajat modulja, es egy uj modul letrehozasa csak
 * azert, hogy legyen hova tenni egy indulasi ellenorzest, tobb szerkezetet adna,
 * mint amennyi kerdest megold.
 */
